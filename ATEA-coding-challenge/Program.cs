...
static class Program
{
    static async Task Main(string[] args)
    {
        try
        {
            ...
            var businessLayer =
                new BusinessLayer((IAteaChallengeRepository)host.Services.GetService(typeof(IAteaChallengeRepository)));
            ...
            while (isContinuing != "N")
            {
                ...
                {
                    case 1:
                        await businessLayer.ReadDbEntries();
                        break;
                    case 2:
                        await businessLayer.FindEntryById();
                        break;
                }
